...
cover:
  provider: imagekit
  image: posts/idv_liryo-kids/cover-motion.gif
  alternativeText: ""
  source: " "
draft: false
private: false
categories:
  - identidade-visual
updatedAt: 2024-11-29T19:43:00.000Z
...
::::div{ className="w-full bg-[#355b94] py-12 text-white" }
:::div{ className="max-w-[70ch] mx-auto prose prose-headings:text-white prose-p:text-white prose-a:text-white prose-img:m-0 prose-img:p-0 prose-img:block" }
## O símbolo
