...
:::div{ className="flex-1 bg-[#F0C030] p-6 sm:p-8 min-w-full sm:min-w-[250px] sm:flex-1" }
### O amarelo  
...
:::div{ className="flex-1 bg-[#221C1C] prose prose-headings:text-white prose-p:text-white p-6 sm:p-8 min-w-full sm:min-w-[250px] sm:flex-1" }
### O marrom escuro  
...
:::div{ className="flex-1 bg-[#303FC8] prose prose-headings:text-white prose-p:text-white p-6 sm:p-8 min-w-full sm:min-w-[250px] sm:flex-1" }
### O Azul  
