...
cover:
  provider: imagekit
  image: posts/idv_santo-espeto/cover5.png
  alternativeText: ""
  source: " "
draft: false
private: false
...
:::div{ className="flex-1 bg-[#F0C030] p-6 sm:p-8 min-w-full sm:min-w-[250px] sm:flex-1 rounded-md" }
### O amarelo  
...
:::div{ className="flex-1 bg-[#221C1C] prose prose-headings:text-white prose-p:text-white p-6 sm:p-8 min-w-full sm:min-w-[250px] sm:flex-1 rounded-md" }
### O marrom escuro  
...
:::div{ className="flex-1 bg-[#303FC8] prose prose-headings:text-white prose-p:text-white p-6 sm:p-8 min-w-full sm:min-w-[250px] sm:flex-1 rounded-md" }
### O Azul  
...
O uso deste tom não só diferencia, mas dialoga com um estilo neon e moderno, integrando-se harmoniosamente à energia da noite e atraindo os olhares para o alternativo e o excepcional.
:::
